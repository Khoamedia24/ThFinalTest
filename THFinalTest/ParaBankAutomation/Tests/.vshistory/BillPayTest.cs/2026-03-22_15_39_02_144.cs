...
namespace THFinalTest.ParaBankAutomation.Tests
{
    ...
    public class BillPayTests : DriverFactory
    {
        ...
        // NHỚ SỬA SỐ NÀY CHO KHỚP VỚI SỐ THỨ TỰ BILL PAY TRONG EXCEL NHÉ
        ...
        private LoginPage? loginPage; // Cần LoginPage để xử lý tiền điều kiện
        ...
        public void ExecuteBillPayTestCase(string testCaseId, string function, string bigItem)
        {
            ...
            try
            {
                ...
                // Sử dụng tài khoản hợp lệ đã tạo từ module Register
                loginPage.EnterUsername("tamnguyen");
                loginPage.EnterPassword("Tam123@");
                ...
                // Chuyển hướng sang trang thanh toán hóa đơn
        ...
        private void ExecuteTestStep(TestStep step)
        {
            ...
            // Phải để xác nhận tài khoản lên trước tài khoản
